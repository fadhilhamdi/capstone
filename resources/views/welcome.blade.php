...
<body class="gradient-bg min-h-screen flex flex-col">
  ...
  <section 
    ...
    style="background-image: url('{{ asset('img/homepage.png') }}');"
  >
    <!-- Overlay -->
    ...
    <div class="relative text-center text-white px-6">
      ...
      <p class="text-xl leading-tight">
        Membantu orang tua mengenali gejala keterlambatan bicara <br />
        dengan cepat dan mudah
      </p>
      <br /><br />
      <a 
        href="{{ route('login') }}"
        class="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-3 px-6 rounded-full shadow-lg"
      > 
        Mulai Screening
      </a>
    </div>
  ...
  <!-- Section Speech Delay -->
  <section id="speech-delay" style="padding: 50px 0; background: #fff;">
    <div style="max-width: 1200px; margin: auto; display: flex; align-items: center; gap: 40px;">
      <!-- Teks -->
      <div style="flex: 1;">
        <h2 style="font-size: 32px; font-weight: bold; color: #333;">
          Apa itu Speech Delay?
        </h2>
        <p style="font-size: 16px; color: #555; line-height: 1.6;">
          Speech delay merupakan salah satu gangguan perkembangan komunikasi yang paling umum terjadi pada anak usia dini. 
          Anak dengan kondisi ini mengalami hambatan dalam kemampuan berbicara, memahami kata, dan mengekspresikan diri secara verbal. 
          Menurut para ahli keterlambatan bicara dapat disebabkan oleh faktor neurologis, psikologis, genetik, 
          serta kurangnya stimulasi dan lingkungan sekitar. Jika tidak ditangani sejak dini, gangguan ini akan menghambat 
          kemampuan sosial, emosi, dan kognitif anak. 
        </p>
      </div>

      <!-- Gambar -->
      <div style="flex: 1;">
        <img src="{{ asset('img/bayi.png') }}" 
             alt="Speech Delay" 
