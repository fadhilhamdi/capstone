        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Nama Anak</h2>
                    <p class="text-lg font-semibold text-gray-700 mb-4">Usia : anak</p>
                ...
                <!-- Diagnosis Awal -->
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Riwayat Pemeriksaan</h2>
                </div>
